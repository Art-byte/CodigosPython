...
class Downloader(object):
    ...
    def download_page(self):
        ...
        self.audioQ_label = Label(self.option, text = "Audio Format")
        ...
        self.audioF_label.grid(column = 0, rows = 2)
        ...
        self.donwload_button = Button(self.download_tab, text = "Download!", command = self.download)
        self.donwload_button.grid(column = 1, row = 5, pady = 15)
